...
/**
 * Dialog that prompts a user to see if a server should be terminated.
 */
class TerminationDialog extends Dialog {
   ...
   */
  TerminationDialog(Shell parentShell, String title, String message) {
    super(parentShell);
    this.title = title;
