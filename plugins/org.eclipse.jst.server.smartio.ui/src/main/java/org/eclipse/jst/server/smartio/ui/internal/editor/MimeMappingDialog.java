 ...
 */
class MimeMappingDialog extends Dialog {

  private MimeMapping map;
   ...
   */
  MimeMappingDialog(Shell parentShell) {
   ...
   */
  MimeMappingDialog(Shell parentShell, MimeMapping map) {
    super(parentShell);
    this.map = map;
    isEdit = true;
  }
  ...
  protected void configureShell(Shell newShell) {
    ...
    newShell.setImage(ServerUIPlugin.getImage(ServerUIPlugin.IMG_MIME_MAPPING));
    if (isEdit) {
   ...
   *
   * @return org.eclipse.jst.server.smartio.MimeMapping
   */
