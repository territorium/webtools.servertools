 ...
 *
 */
public interface IServerWrapperWorkingCopy extends IServerWrapper {
  ...
  /**
   * Sets the instance directory for the server. If set to null, the instance directory is derived
   * from the testEnvironment setting.'
   * 
  ...
  /**
   * Set this server to save contexts to separate context files when publishing the server.
   * 
   * @param b true if contexts should be saved to separate files when publishing the server
   */
