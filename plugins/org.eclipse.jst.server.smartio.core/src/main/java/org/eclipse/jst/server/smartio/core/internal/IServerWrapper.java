...
public interface IServerWrapper extends IURLProvider {
  ...
  /**
   * Property which specifies the directory where the server instance exists. If not specified,
   * instance directory is derived from the textEnvironment setting.
   */
  ...
  /**
   * Property which specifies contexts in the server.xml file should be saved to separate context
   * files.
   */
  public static final String PROPERTY_SAVE_SEPARATE_CONTEXT_FILES   = "saveSeparateContextFiles";

  /**
   * Property which specifies contexts in the server.xml file should be reloadable by default.
   */
  ...
  /**
   * Gets the directory where the server instance exists. If not set, the instance directory is
   * derived from the testEnvironment setting.
   * 
  ...
  /**
   * Returns true if contexts should be saved to separate context files instead of being kept within
   * server.xml when the server is published.
   * 
