...
public class Context extends XMLElement {
  ...
  /**
   * Get WTP source attribute. Links the context to a project module.
   * 
  ...
  /**
   * Get context Resources element. Will create the element if it does not already exist.
   * 
  ...
  /**
   * Get context Loader element. Will create the element if it does not already exist.
   * 
  ...
  /**
   * Set WTP source attribute. Links the context to a project module.
   * 
