 ...
 *
 * Contributors: Fabrizio Giustina - Initial API and implementation Matteo TURRA - Support for
 * multiple web resource paths
 **********************************************************************/

package org.eclipse.jst.server.smartio.core.internal.xml.server40;

import org.eclipse.jst.server.smartio.core.internal.xml.XMLElement;
...
public class Resources extends XMLElement {
  ...
  /**
   * Get extraResourcePaths attribute. These are resource paths in addition to the path specified by
   * docBase.
   * 
   ...
   * 
   * @param extraResourcePaths A semicolon separated list of absolute resource paths not including
   *        the path specified by docBase.
   */
