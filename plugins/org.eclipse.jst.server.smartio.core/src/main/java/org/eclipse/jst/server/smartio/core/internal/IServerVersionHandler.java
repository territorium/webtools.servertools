...
public interface IServerVersionHandler {
   ...
   * @return OK status if a valid installation exists at the location. If not valid, the IStatus
   ...
   * 
   * @param installPath an installation path
   * @return list of classpath entries required to start the server.
   */
  ...
  /**
   * Gets the subset of the startup VM arguments for the server that apply to all compatible
   * JVM versions.
   * 
  ...
  /**
   * Gets the contents of the Java policy file for the server.
   * 
  ...
  /**
   * Prepare server runtime directory. Create catalina instance set of directories.
   * 
   * @param baseDir
   */
   ...
   * 
   * @param deployPath path to the deployment directory being prepared
  ...
  /**
   * Gets the name of the "shared" loader to use with serving modules without publishing. Returns
   * null if serving modules without publishing is not supported.
   * 
   * @param baseDir
   */
  ...
  /**
   * Returns true if this server supports a debug argument. This argument is expected to affect the
   * level of logging. Newer versions of server use different means of controlling logging and
  ...
  /**
   * Returns the endorsed directories derived using the specified install path.
   * 
   * @param installPath installation path for the server
