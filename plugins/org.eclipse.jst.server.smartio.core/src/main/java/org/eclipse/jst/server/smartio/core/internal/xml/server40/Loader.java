 ...
 *
 * Contributors: Fabrizio Giustina - Initial API and implementation
 **********************************************************************/
...
public class Loader extends XMLElement {
   ...
   */
  public void setUseSystemClassLoaderAsParent(String useSystemClassLoaderAsParent) {
    setAttributeValue("useSystemClassLoaderAsParent", useSystemClassLoaderAsParent);
  }
